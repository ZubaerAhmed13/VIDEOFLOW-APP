...
class ProfessionalCombinedExportInstrumentedTest {
    @Test
    fun combinedEnhanceEffectsAndAi_renderThroughProductionPipeline() = runBlocking {
        val context = ApplicationProvider.getApplicationContext<Context>()
        val testContext = InstrumentationRegistry.getInstrumentation().context
        val resolver = context.contentResolver
        val suffix = System.currentTimeMillis().toString()
        val projectId = "professional-combined-export-$suffix"
        ...
        try {
            ...
            val marker =
                "PROFESSIONAL_COMBINED_EXPORT_CERTIFIED project=$projectId bytes=${result.outputBytes} " +
